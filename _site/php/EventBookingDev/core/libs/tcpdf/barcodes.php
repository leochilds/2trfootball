...
class TCPDFBarcode {
	 ...
	 * @param $color (string) Foreground color (in SVG format) for bar elements (background is transparent).
 	 * @public
	 */
	function getBarcodeSVG($w=2, $h=30, $color='black') {
		// send headers
	 ...
	 * @param $color (string) Foreground color (in SVG format) for bar elements (background is transparent).
 	 ...
 	 * @public
	 */
	function getBarcodeSVGcode($w=2, $h=30, $color='black') {
	 ...
	 * @param $color (string) Foreground color for bar elements (background is transparent).
 	 ...
 	 * @public
	 */
	function getBarcodeHTML($w=2, $h=30, $color='black') {
	 ...
	 * @param $color (array) RGB (0-255) foreground color for bar elements (background is transparent).
 	 ...
 	 * @public
	 */
	function getBarcodePNG($w=2, $h=30, $color=array(0,0,0)) {
	 ...
	 * @protected
	 */
	function barcode_msi($code, $checksum=false) {
		$chr['0'] = '100100100100';
		$chr['1'] = '100100100110';
		$chr['2'] = '100100110100';
		$chr['3'] = '100100110110';
	 ...
	 * @protected
	 */
	function barcode_s25($code, $checksum=false) {
	 ...
	 * @protected
	 */
	function binseq_to_array($seq, $bararray) {
		$len = strlen($seq);
		$w = 0;
		$k = 0;
		for ($i = 0; $i < $len; ++$i) {
	 ...
	 * @protected
	 */
	function barcode_i25($code, $checksum=false) {
		$chr['0'] = '11221';
		$chr['1'] = '21112';
		$chr['2'] = '12112';
		$chr['3'] = '22111';
	 ...
	 * @protected
	 */
	function barcode_c128($code, $type='') {
		$chr = array(
			'212222', /* 00 */
			'222122', /* 01 */
			'222221', /* 02 */
	 ...
	 * @protected
	 */
	function get128ABsequence($code) {
		$len = strlen($code);
		$sequence = array();
	 ...
	 * @protected
	 */
	function barcode_eanupc($code, $len=13) {
		$upce = false;
		if ($len == 6) {
			$len = 12; // UPC-A
	 ...
	 * @protected
	 */
	function barcode_eanext($code, $len=5) {
		//Padding
	 ...
	 * @protected
	 */
	function barcode_postnet($code, $planet=false) {
		// bar lenght
		if ($planet) {
			$barlen = Array(
				0 => Array(1,1,2,2,2),
	 ...
	 * @protected
	 */
	function barcode_rms4cc($code, $kix=false) {
		$notkix = !$kix;
		// bar mode
		// 1 = pos 1, length 2
		// 2 = pos 1, length 3
	 ...
	 * @protected
	 */
	function barcode_pharmacode($code) {
		$seq = '';
		$code = intval($code);
		while ($code > 0) {
			if (($code % 2) == 0) {
	 ...
	 * @protected
	 */
	function barcode_pharmacode2t($code) {
		$seq = '';
		$code = intval($code);
		do {
			switch ($code % 3) {
	 ...
	 * @protected
	 */
	function imb_crc11fcs($code_arr) {
