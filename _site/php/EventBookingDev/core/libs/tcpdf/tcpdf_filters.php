...
class TCPDF_FILTERS {
	 ...
	 * @private
	 */
	var $available_filters = array('ASCIIHexDecode', 'ASCII85Decode', 'LZWDecode', 'FlateDecode', 'RunLengthDecode');
...
// -----------------------------------------------------------------------------
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilter($filter, $data) {
		switch ($filter) {
			case 'ASCIIHexDecode': {
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilterStandard($data) {
		return $data;
	}
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilterASCIIHexDecode($data) {
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilterASCII85Decode($data) {
		// intialize string to return
		$decoded = '';
		// all white-space characters shall be ignored
		$data = preg_replace('/[\s]/', '', $data);
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilterFlateDecode($data) {
		// intialize string to return
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilterRunLengthDecode($data) {
		// intialize string to return
		$decoded = '';
		// data length
		$data_length = strlen($data);
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilterCCITTFaxDecode($data) {
		return $data;
	}
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilterJBIG2Decode($data) {
		return $data;
	}
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilterDCTDecode($data) {
		return $data;
	}
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilterJPXDecode($data) {
		return $data;
	}
	 ...
	 * @since 1.0.000 (2011-05-23)
	 */
	function decodeFilterCrypt($data) {
		return $data;
	}
