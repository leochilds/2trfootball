			...
			<div class="ebcal-form-inner-container">
				...
				if (in_array($tpl['option_arr']['o_bf_include_zip'], array(2, 3)))
				{
					...
					<p>
						...
						<input type="text" name="customer_zip" maxlength="8" class="ebcal-field ebc-w300<?php echo $tpl['option_arr']['o_bf_include_zip'] == 3 ? ' ebcal-required' : NULL; ?>" value="<?php echo isset($_POST['customer_zip']) ? htmlspecialchars($_POST['customer_zip']) : NULL; ?>" lang="<?php echo htmlspecialchars($front_required['zip']); ?>" />
					</p>
					<?php
				}
				...
				<p>
					...
					<input type="button" name="ebcal_booking_form_submit" class="ebcal-button ebc-float-left" data-id="<?php echo $tpl['arr']['id']?>" value="<?php __('front_button_submit');?>">&nbsp;
					<input type="button" name="ebcal_booking_form_cancel" class="ebcal-button ebcal-grey-button" data-id="<?php echo $tpl['arr']['id']?>" value="<?php __('front_button_cancel');?>">
				</p>
			</div>
		</form>
	</div>
