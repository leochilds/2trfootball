		...
		if ($("#grid").length > 0 && datagrid) {
			...
			var $grid = $("#grid").datagrid({
				...
				columns: [{text: myLabel.name, type: "text", sortable: true, editable: true},
				          ...
				          {text: myLabel.created, type: "date", sortable: true, editable: false, width: 150, renderer: $.datagrid._formatDate, dateFormat: pjGrid.jsDateFormat},
				          {text: myLabel.role, type: "text", sortable: true, width: 60, renderer: formatRole},
