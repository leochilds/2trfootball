...
class pjOptionModel extends pjAppModel
{
	...
	protected $i18n = array('confirm_subject_client', 'confirm_tokens_client', 'payment_subject_client', 'payment_tokens_client',
		...
		'register_subject', 'register_tokens', 'forgot_subject', 'forgot_tokens'
	);
