									...
									<tr>
										...
										foreach ($tpl['lp_arr'] as $v)
										{
											...
											<p class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
												<span class="inline_block">
													<input type="text" name="i18n[<?php echo $v['id']; ?>][extra_name][{INDEX}]" class="pj-form-field w300" />
										...
										<td class="align_top">
											<span class="pj-form-field-custom pj-form-field-custom-before">
												...
												<input type="text" name="extra_price[{INDEX}]" class="pj-form-field w80 align_right" />
											</span>
										</td>
								...
								<tbody>
									<tr>
										...
										foreach ($tpl['lp_arr'] as $v)
										{
											...
											<p class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
												<span class="inline_block">
													<input type="text" name="i18n[<?php echo $v['id']; ?>][extra_title][{INDEX}]" class="pj-form-field w300" disabled="disabled" />
													<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
												</span>
											</p>
											<?php
									...
									<tr>
										...
										foreach ($tpl['lp_arr'] as $v)
										{
											...
											<p class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
												<span class="inline_block">
													<input type="text" name="i18n[<?php echo $v['id']; ?>][extra_name][{INDEX}][{X}]" class="pj-form-field w300" disabled="disabled" />
													<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
												</span>
											</p>
											<?php
										...
										<td class="align_top">
											<span class="pj-form-field-custom pj-form-field-custom-before">
												<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $tpl['option_arr']['o_currency'], ""); ?></abbr></span>
												<input type="text" name="extra_price[{INDEX}][{X}]" class="pj-form-field w80 align_right" disabled="disabled" />
											</span>
										</td>
	...
	<tbody>
		<tr>
			...
			foreach ($tpl['lp_arr'] as $v)
			{
				...
				<p class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
					<span class="inline_block">
						<input type="text" name="i18n[<?php echo $v['id']; ?>][extra_name][{INDEX}][{X}]" class="pj-form-field w300" />
						<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
					</span>
				</p>
				<?php
			...
			<td class="align_top">
				<span class="pj-form-field-custom pj-form-field-custom-before">
					<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $tpl['option_arr']['o_currency'], ""); ?></abbr></span>
					<input type="text" name="extra_price[{INDEX}][{X}]" class="pj-form-field w80 align_right" />
				</span>
			</td>
			<td><a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="pj-icon-delete btnRemoveExtraItem"></a></td>
		</tr>
