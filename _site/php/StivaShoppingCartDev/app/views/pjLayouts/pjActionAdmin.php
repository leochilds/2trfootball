...
<html>
	...
	<body>
		<div id="container">
			<div id="header">
				<a href="http://www.phpjabbers.com/stiva-shopping-cart/" id="logo" target="_blank"><img src="<?php echo PJ_INSTALL_URL . PJ_IMG_PATH; ?>backend/logo.png" alt="Shopping Cart" /></a>
			</div>
