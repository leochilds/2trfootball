...
if (!defined("PJ_GALLERY_SMALL")) define("PJ_GALLERY_SMALL", "80,106");
if (!defined("PJ_GALLERY_MEDIUM")) define("PJ_GALLERY_MEDIUM", "240,320");
if (!defined("PJ_GALLERY_FILL_COLOR")) define("PJ_GALLERY_FILL_COLOR", "255,255,255");
if (!defined("PJ_GALLERY_CROP")) define("PJ_GALLERY_CROP", "true");

if (!defined("PJ_SCRIPT_VERSION")) define("PJ_SCRIPT_VERSION", "4.0");
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "57");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "4.0.6");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "shopping_cart_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjBackup', 'pjLog', 'pjInstaller', 'pjOneAdmin',  'pjAuthorize', 'pjPaypal', 'pjInvoice', 'pjGallery', 'pjSms');
?>