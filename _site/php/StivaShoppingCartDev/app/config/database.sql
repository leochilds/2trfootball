...
DROP TABLE IF EXISTS `shopping_cart_countries`;
CREATE TABLE IF NOT EXISTS `shopping_cart_countries` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `status` enum('T','F') NOT NULL DEFAULT 'T',
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
...
INSERT INTO `shopping_cart_countries` (`id`, `status`) VALUES
(1, 'T'),
(2, 'T'),
(3, 'T'),
(4, 'T'),
...
(NULL, '1041', 'pjField', '1', 'title', '', 'script'),
(NULL, '1041', 'pjField', '2', 'title', '', 'script'),
(NULL, '1041', 'pjField', '3', 'title', '', 'script'),
...
(NULL, '1', 'pjCountry', '1', 'name', 'Afghanistan', 'script'),
(NULL, '2', 'pjCountry', '1', 'name', 'Albania', 'script'),
(NULL, '3', 'pjCountry', '1', 'name', 'Algeria', 'script'),
(NULL, '4', 'pjCountry', '1', 'name', 'American Samoa', 'script'),
(NULL, '5', 'pjCountry', '1', 'name', 'Andorra', 'script'),
(NULL, '6', 'pjCountry', '1', 'name', 'Angola', 'script'),
(NULL, '7', 'pjCountry', '1', 'name', 'Anguilla', 'script'),
(NULL, '8', 'pjCountry', '1', 'name', 'Antarctica', 'script'),
(NULL, '9', 'pjCountry', '1', 'name', 'Antigua and Barbuda', 'script'),
(NULL, '10', 'pjCountry', '1', 'name', 'Argentina', 'script'),
(NULL, '11', 'pjCountry', '1', 'name', 'Armenia', 'script'),
(NULL, '12', 'pjCountry', '1', 'name', 'Arctic Ocean', 'script'),
(NULL, '13', 'pjCountry', '1', 'name', 'Aruba', 'script'),
(NULL, '14', 'pjCountry', '1', 'name', 'Ashmore and Cartier Islands', 'script'),
(NULL, '15', 'pjCountry', '1', 'name', 'Atlantic Ocean', 'script'),
(NULL, '16', 'pjCountry', '1', 'name', 'Australia', 'script'),
(NULL, '17', 'pjCountry', '1', 'name', 'Austria', 'script'),
(NULL, '18', 'pjCountry', '1', 'name', 'Azerbaijan', 'script'),
(NULL, '19', 'pjCountry', '1', 'name', 'Bahamas', 'script'),
(NULL, '20', 'pjCountry', '1', 'name', 'Bahrain', 'script'),
(NULL, '21', 'pjCountry', '1', 'name', 'Baker Island', 'script'),
(NULL, '22', 'pjCountry', '1', 'name', 'Bangladesh', 'script'),
(NULL, '23', 'pjCountry', '1', 'name', 'Barbados', 'script'),
(NULL, '24', 'pjCountry', '1', 'name', 'Bassas da India', 'script'),
(NULL, '25', 'pjCountry', '1', 'name', 'Belarus', 'script'),
(NULL, '26', 'pjCountry', '1', 'name', 'Belgium', 'script'),
(NULL, '27', 'pjCountry', '1', 'name', 'Belize', 'script'),
(NULL, '28', 'pjCountry', '1', 'name', 'Benin', 'script'),
(NULL, '29', 'pjCountry', '1', 'name', 'Bermuda', 'script'),
(NULL, '30', 'pjCountry', '1', 'name', 'Bhutan', 'script'),
(NULL, '31', 'pjCountry', '1', 'name', 'Bolivia', 'script'),
(NULL, '32', 'pjCountry', '1', 'name', 'Borneo', 'script'),
(NULL, '33', 'pjCountry', '1', 'name', 'Bosnia and Herzegovina', 'script'),
(NULL, '34', 'pjCountry', '1', 'name', 'Botswana', 'script'),
(NULL, '35', 'pjCountry', '1', 'name', 'Bouvet Island', 'script'),
(NULL, '36', 'pjCountry', '1', 'name', 'Brazil', 'script'),
(NULL, '37', 'pjCountry', '1', 'name', 'British Virgin Islands', 'script'),
(NULL, '38', 'pjCountry', '1', 'name', 'Brunei', 'script'),
(NULL, '39', 'pjCountry', '1', 'name', 'Bulgaria', 'script'),
(NULL, '40', 'pjCountry', '1', 'name', 'Burkina Faso', 'script'),
(NULL, '41', 'pjCountry', '1', 'name', 'Burundi', 'script'),
(NULL, '42', 'pjCountry', '1', 'name', 'Cambodia', 'script'),
(NULL, '43', 'pjCountry', '1', 'name', 'Cameroon', 'script'),
(NULL, '44', 'pjCountry', '1', 'name', 'Canada', 'script'),
(NULL, '45', 'pjCountry', '1', 'name', 'Cape Verde', 'script'),
(NULL, '46', 'pjCountry', '1', 'name', 'Cayman Islands', 'script'),
(NULL, '47', 'pjCountry', '1', 'name', 'Central African Republic', 'script'),
(NULL, '48', 'pjCountry', '1', 'name', 'Chad', 'script'),
(NULL, '49', 'pjCountry', '1', 'name', 'Chile', 'script'),
(NULL, '50', 'pjCountry', '1', 'name', 'China', 'script'),
(NULL, '51', 'pjCountry', '1', 'name', 'Christmas Island', 'script'),
(NULL, '52', 'pjCountry', '1', 'name', 'Clipperton Island', 'script'),
(NULL, '53', 'pjCountry', '1', 'name', 'Cocos Islands', 'script'),
(NULL, '54', 'pjCountry', '1', 'name', 'Colombia', 'script'),
(NULL, '55', 'pjCountry', '1', 'name', 'Comoros', 'script'),
(NULL, '56', 'pjCountry', '1', 'name', 'Cook Islands', 'script'),
(NULL, '57', 'pjCountry', '1', 'name', 'Coral Sea Islands', 'script'),
(NULL, '58', 'pjCountry', '1', 'name', 'Costa Rica', 'script'),
(NULL, '59', 'pjCountry', '1', 'name', 'Cote d''Ivoire', 'script'),
(NULL, '60', 'pjCountry', '1', 'name', 'Croatia', 'script'),
(NULL, '61', 'pjCountry', '1', 'name', 'Cuba', 'script'),
(NULL, '62', 'pjCountry', '1', 'name', 'Cyprus', 'script'),
(NULL, '63', 'pjCountry', '1', 'name', 'Czech Republic', 'script'),
(NULL, '64', 'pjCountry', '1', 'name', 'Denmark', 'script'),
(NULL, '65', 'pjCountry', '1', 'name', 'Democratic Republic of the Congo', 'script'),
(NULL, '66', 'pjCountry', '1', 'name', 'Djibouti', 'script'),
(NULL, '67', 'pjCountry', '1', 'name', 'Dominica', 'script'),
(NULL, '68', 'pjCountry', '1', 'name', 'Dominican Republic', 'script'),
(NULL, '69', 'pjCountry', '1', 'name', 'East Timor', 'script'),
(NULL, '70', 'pjCountry', '1', 'name', 'Ecuador', 'script'),
(NULL, '71', 'pjCountry', '1', 'name', 'Egypt', 'script'),
(NULL, '72', 'pjCountry', '1', 'name', 'El Salvador', 'script'),
(NULL, '73', 'pjCountry', '1', 'name', 'Equatorial Guinea', 'script'),
(NULL, '74', 'pjCountry', '1', 'name', 'Eritrea', 'script'),
(NULL, '75', 'pjCountry', '1', 'name', 'Estonia', 'script'),
(NULL, '76', 'pjCountry', '1', 'name', 'Ethiopia', 'script'),
(NULL, '77', 'pjCountry', '1', 'name', 'Europa Island', 'script'),
(NULL, '78', 'pjCountry', '1', 'name', 'Falkland Islands (Islas Malvinas)', 'script'),
(NULL, '79', 'pjCountry', '1', 'name', 'Faroe Islands', 'script'),
(NULL, '80', 'pjCountry', '1', 'name', 'Fiji', 'script'),
(NULL, '81', 'pjCountry', '1', 'name', 'Finland', 'script'),
(NULL, '82', 'pjCountry', '1', 'name', 'France', 'script'),
(NULL, '83', 'pjCountry', '1', 'name', 'French Guiana', 'script'),
(NULL, '84', 'pjCountry', '1', 'name', 'French Polynesia', 'script'),
(NULL, '85', 'pjCountry', '1', 'name', 'French Southern and Antarctic Lands', 'script'),
(NULL, '86', 'pjCountry', '1', 'name', 'Gabon', 'script'),
(NULL, '87', 'pjCountry', '1', 'name', 'Gambia', 'script'),
(NULL, '88', 'pjCountry', '1', 'name', 'Gaza Strip', 'script'),
(NULL, '89', 'pjCountry', '1', 'name', 'Georgia', 'script'),
(NULL, '90', 'pjCountry', '1', 'name', 'Germany', 'script'),
(NULL, '91', 'pjCountry', '1', 'name', 'Ghana', 'script'),
(NULL, '92', 'pjCountry', '1', 'name', 'Gibraltar', 'script'),
(NULL, '93', 'pjCountry', '1', 'name', 'Glorioso Islands', 'script'),
(NULL, '94', 'pjCountry', '1', 'name', 'Greece', 'script'),
(NULL, '95', 'pjCountry', '1', 'name', 'Greenland', 'script'),
(NULL, '96', 'pjCountry', '1', 'name', 'Grenada', 'script'),
(NULL, '97', 'pjCountry', '1', 'name', 'Guadeloupe', 'script'),
(NULL, '98', 'pjCountry', '1', 'name', 'Guam', 'script'),
(NULL, '99', 'pjCountry', '1', 'name', 'Guatemala', 'script'),
(NULL, '100', 'pjCountry', '1', 'name', 'Guernsey', 'script'),
(NULL, '101', 'pjCountry', '1', 'name', 'Guinea', 'script'),
(NULL, '102', 'pjCountry', '1', 'name', 'Guinea-Bissau', 'script'),
(NULL, '103', 'pjCountry', '1', 'name', 'Guyana', 'script'),
(NULL, '104', 'pjCountry', '1', 'name', 'Haiti', 'script'),
(NULL, '105', 'pjCountry', '1', 'name', 'Heard Island and McDonald Islands', 'script'),
(NULL, '106', 'pjCountry', '1', 'name', 'Honduras', 'script'),
(NULL, '107', 'pjCountry', '1', 'name', 'Hong Kong', 'script'),
(NULL, '108', 'pjCountry', '1', 'name', 'Howland Island', 'script'),
(NULL, '109', 'pjCountry', '1', 'name', 'Hungary', 'script'),
(NULL, '110', 'pjCountry', '1', 'name', 'Iceland', 'script'),
(NULL, '111', 'pjCountry', '1', 'name', 'India', 'script'),
(NULL, '112', 'pjCountry', '1', 'name', 'Indian Ocean', 'script'),
(NULL, '113', 'pjCountry', '1', 'name', 'Indonesia', 'script'),
(NULL, '114', 'pjCountry', '1', 'name', 'Iran', 'script'),
(NULL, '115', 'pjCountry', '1', 'name', 'Iraq', 'script'),
(NULL, '116', 'pjCountry', '1', 'name', 'Ireland', 'script'),
(NULL, '117', 'pjCountry', '1', 'name', 'Isle of Man', 'script'),
(NULL, '118', 'pjCountry', '1', 'name', 'Israel', 'script'),
(NULL, '119', 'pjCountry', '1', 'name', 'Italy', 'script'),
(NULL, '120', 'pjCountry', '1', 'name', 'Jamaica', 'script'),
(NULL, '121', 'pjCountry', '1', 'name', 'Jan Mayen', 'script'),
(NULL, '122', 'pjCountry', '1', 'name', 'Japan', 'script'),
(NULL, '123', 'pjCountry', '1', 'name', 'Jarvis Island', 'script'),
(NULL, '124', 'pjCountry', '1', 'name', 'Jersey', 'script'),
(NULL, '125', 'pjCountry', '1', 'name', 'Johnston Atoll', 'script'),
(NULL, '126', 'pjCountry', '1', 'name', 'Jordan', 'script'),
(NULL, '127', 'pjCountry', '1', 'name', 'Juan de Nova Island', 'script'),
(NULL, '128', 'pjCountry', '1', 'name', 'Kazakhstan', 'script'),
(NULL, '129', 'pjCountry', '1', 'name', 'Kenya', 'script'),
(NULL, '130', 'pjCountry', '1', 'name', 'Kingman Reef', 'script'),
(NULL, '131', 'pjCountry', '1', 'name', 'Kiribati', 'script'),
(NULL, '132', 'pjCountry', '1', 'name', 'Kerguelen Archipelago', 'script'),
(NULL, '133', 'pjCountry', '1', 'name', 'Kosovo', 'script'),
(NULL, '134', 'pjCountry', '1', 'name', 'Kuwait', 'script'),
(NULL, '135', 'pjCountry', '1', 'name', 'Kyrgyzstan', 'script'),
(NULL, '136', 'pjCountry', '1', 'name', 'Laos', 'script'),
(NULL, '137', 'pjCountry', '1', 'name', 'Latvia', 'script'),
(NULL, '138', 'pjCountry', '1', 'name', 'Lebanon', 'script'),
(NULL, '139', 'pjCountry', '1', 'name', 'Lesotho', 'script'),
(NULL, '140', 'pjCountry', '1', 'name', 'Liberia', 'script'),
(NULL, '141', 'pjCountry', '1', 'name', 'Libya', 'script'),
(NULL, '142', 'pjCountry', '1', 'name', 'Liechtenstein', 'script'),
(NULL, '143', 'pjCountry', '1', 'name', 'Lithuania', 'script'),
(NULL, '144', 'pjCountry', '1', 'name', 'Luxembourg', 'script'),
(NULL, '145', 'pjCountry', '1', 'name', 'Macau', 'script'),
(NULL, '146', 'pjCountry', '1', 'name', 'Macedonia', 'script'),
(NULL, '147', 'pjCountry', '1', 'name', 'Madagascar', 'script'),
(NULL, '148', 'pjCountry', '1', 'name', 'Malawi', 'script'),
(NULL, '149', 'pjCountry', '1', 'name', 'Malaysia', 'script'),
(NULL, '150', 'pjCountry', '1', 'name', 'Maldives', 'script'),
(NULL, '151', 'pjCountry', '1', 'name', 'Mali', 'script'),
(NULL, '152', 'pjCountry', '1', 'name', 'Malta', 'script'),
(NULL, '153', 'pjCountry', '1', 'name', 'Marshall Islands', 'script'),
(NULL, '154', 'pjCountry', '1', 'name', 'Martinique', 'script'),
(NULL, '155', 'pjCountry', '1', 'name', 'Mauritania', 'script'),
(NULL, '156', 'pjCountry', '1', 'name', 'Mauritius', 'script'),
(NULL, '157', 'pjCountry', '1', 'name', 'Mayotte', 'script'),
(NULL, '158', 'pjCountry', '1', 'name', 'Mediterranean Sea', 'script'),
(NULL, '159', 'pjCountry', '1', 'name', 'Mexico', 'script'),
(NULL, '160', 'pjCountry', '1', 'name', 'Micronesia', 'script'),
(NULL, '161', 'pjCountry', '1', 'name', 'Midway Islands', 'script'),
(NULL, '162', 'pjCountry', '1', 'name', 'Moldova', 'script'),
(NULL, '163', 'pjCountry', '1', 'name', 'Monaco', 'script'),
(NULL, '164', 'pjCountry', '1', 'name', 'Mongolia', 'script'),
(NULL, '165', 'pjCountry', '1', 'name', 'Montenegro', 'script'),
(NULL, '166', 'pjCountry', '1', 'name', 'Montserrat', 'script'),
(NULL, '167', 'pjCountry', '1', 'name', 'Morocco', 'script'),
(NULL, '168', 'pjCountry', '1', 'name', 'Mozambique', 'script'),
(NULL, '169', 'pjCountry', '1', 'name', 'Myanmar', 'script'),
(NULL, '170', 'pjCountry', '1', 'name', 'Namibia', 'script'),
(NULL, '171', 'pjCountry', '1', 'name', 'Nauru', 'script'),
(NULL, '172', 'pjCountry', '1', 'name', 'Navassa Island', 'script'),
(NULL, '173', 'pjCountry', '1', 'name', 'Nepal', 'script'),
(NULL, '174', 'pjCountry', '1', 'name', 'Netherlands', 'script'),
(NULL, '175', 'pjCountry', '1', 'name', 'Netherlands Antilles', 'script'),
(NULL, '176', 'pjCountry', '1', 'name', 'New Caledonia', 'script'),
(NULL, '177', 'pjCountry', '1', 'name', 'New Zealand', 'script'),
(NULL, '178', 'pjCountry', '1', 'name', 'Nicaragua', 'script'),
(NULL, '179', 'pjCountry', '1', 'name', 'Niger', 'script'),
(NULL, '180', 'pjCountry', '1', 'name', 'Nigeria', 'script'),
(NULL, '181', 'pjCountry', '1', 'name', 'Niue', 'script'),
(NULL, '182', 'pjCountry', '1', 'name', 'Norfolk Island', 'script'),
(NULL, '183', 'pjCountry', '1', 'name', 'North Korea', 'script'),
(NULL, '184', 'pjCountry', '1', 'name', 'North Sea', 'script'),
(NULL, '185', 'pjCountry', '1', 'name', 'Northern Mariana Islands', 'script'),
(NULL, '186', 'pjCountry', '1', 'name', 'Norway', 'script'),
(NULL, '187', 'pjCountry', '1', 'name', 'Oman', 'script'),
(NULL, '188', 'pjCountry', '1', 'name', 'Pacific Ocean', 'script'),
(NULL, '189', 'pjCountry', '1', 'name', 'Pakistan', 'script'),
(NULL, '190', 'pjCountry', '1', 'name', 'Palau', 'script'),
(NULL, '191', 'pjCountry', '1', 'name', 'Palmyra Atoll', 'script'),
(NULL, '192', 'pjCountry', '1', 'name', 'Panama', 'script'),
(NULL, '193', 'pjCountry', '1', 'name', 'Papua New Guinea', 'script'),
(NULL, '194', 'pjCountry', '1', 'name', 'Paracel Islands', 'script'),
(NULL, '195', 'pjCountry', '1', 'name', 'Paraguay', 'script'),
(NULL, '196', 'pjCountry', '1', 'name', 'Peru', 'script'),
(NULL, '197', 'pjCountry', '1', 'name', 'Philippines', 'script'),
(NULL, '198', 'pjCountry', '1', 'name', 'Pitcairn Islands', 'script'),
(NULL, '199', 'pjCountry', '1', 'name', 'Poland', 'script'),
(NULL, '200', 'pjCountry', '1', 'name', 'Portugal', 'script'),
(NULL, '201', 'pjCountry', '1', 'name', 'Puerto Rico', 'script'),
(NULL, '202', 'pjCountry', '1', 'name', 'Qatar', 'script'),
(NULL, '203', 'pjCountry', '1', 'name', 'Reunion', 'script'),
(NULL, '204', 'pjCountry', '1', 'name', 'Republic of the Congo', 'script'),
(NULL, '205', 'pjCountry', '1', 'name', 'Romania', 'script'),
(NULL, '206', 'pjCountry', '1', 'name', 'Ross Sea', 'script'),
(NULL, '207', 'pjCountry', '1', 'name', 'Russia', 'script'),
(NULL, '208', 'pjCountry', '1', 'name', 'Rwanda', 'script'),
(NULL, '209', 'pjCountry', '1', 'name', 'Saint Helena', 'script'),
(NULL, '210', 'pjCountry', '1', 'name', 'Saint Kitts and Nevis', 'script'),
(NULL, '211', 'pjCountry', '1', 'name', 'Saint Lucia', 'script'),
(NULL, '212', 'pjCountry', '1', 'name', 'Saint Pierre and Miquelon', 'script'),
(NULL, '213', 'pjCountry', '1', 'name', 'Saint Vincent and the Grenadines', 'script'),
(NULL, '214', 'pjCountry', '1', 'name', 'Samoa', 'script'),
(NULL, '215', 'pjCountry', '1', 'name', 'San Marino', 'script'),
(NULL, '216', 'pjCountry', '1', 'name', 'Sao Tome and Principe', 'script'),
(NULL, '217', 'pjCountry', '1', 'name', 'Saudi Arabia', 'script'),
(NULL, '218', 'pjCountry', '1', 'name', 'Senegal', 'script'),
(NULL, '219', 'pjCountry', '1', 'name', 'Serbia', 'script'),
(NULL, '220', 'pjCountry', '1', 'name', 'Seychelles', 'script'),
(NULL, '221', 'pjCountry', '1', 'name', 'Sierra Leone', 'script'),
(NULL, '222', 'pjCountry', '1', 'name', 'Singapore', 'script'),
(NULL, '223', 'pjCountry', '1', 'name', 'Slovakia', 'script'),
(NULL, '224', 'pjCountry', '1', 'name', 'Slovenia', 'script'),
(NULL, '225', 'pjCountry', '1', 'name', 'Solomon Islands', 'script'),
(NULL, '226', 'pjCountry', '1', 'name', 'Somalia', 'script'),
(NULL, '227', 'pjCountry', '1', 'name', 'South Africa', 'script'),
(NULL, '228', 'pjCountry', '1', 'name', 'South Georgia and the South Sandwich Islands', 'script'),
(NULL, '229', 'pjCountry', '1', 'name', 'South Korea', 'script'),
(NULL, '230', 'pjCountry', '1', 'name', 'Southern Ocean', 'script'),
(NULL, '231', 'pjCountry', '1', 'name', 'Spain', 'script'),
(NULL, '232', 'pjCountry', '1', 'name', 'Spratly Islands', 'script'),
(NULL, '233', 'pjCountry', '1', 'name', 'Sri Lanka', 'script'),
(NULL, '234', 'pjCountry', '1', 'name', 'Sudan', 'script'),
(NULL, '235', 'pjCountry', '1', 'name', 'Suriname', 'script'),
(NULL, '236', 'pjCountry', '1', 'name', 'Svalbard', 'script'),
(NULL, '237', 'pjCountry', '1', 'name', 'Swaziland', 'script'),
(NULL, '238', 'pjCountry', '1', 'name', 'Sweden', 'script'),
(NULL, '239', 'pjCountry', '1', 'name', 'Switzerland', 'script'),
(NULL, '240', 'pjCountry', '1', 'name', 'Syria', 'script'),
(NULL, '241', 'pjCountry', '1', 'name', 'Taiwan', 'script'),
(NULL, '242', 'pjCountry', '1', 'name', 'Tajikistan', 'script'),
(NULL, '243', 'pjCountry', '1', 'name', 'Tanzania', 'script'),
(NULL, '244', 'pjCountry', '1', 'name', 'Tasman Sea', 'script'),
(NULL, '245', 'pjCountry', '1', 'name', 'Thailand', 'script'),
(NULL, '246', 'pjCountry', '1', 'name', 'Togo', 'script'),
(NULL, '247', 'pjCountry', '1', 'name', 'Tokelau', 'script'),
(NULL, '248', 'pjCountry', '1', 'name', 'Tonga', 'script'),
(NULL, '249', 'pjCountry', '1', 'name', 'Trinidad and Tobago', 'script'),
(NULL, '250', 'pjCountry', '1', 'name', 'Tromelin Island', 'script'),
(NULL, '251', 'pjCountry', '1', 'name', 'Tunisia', 'script'),
(NULL, '252', 'pjCountry', '1', 'name', 'Turkey', 'script'),
(NULL, '253', 'pjCountry', '1', 'name', 'Turkmenistan', 'script'),
(NULL, '254', 'pjCountry', '1', 'name', 'Turks and Caicos Islands', 'script'),
(NULL, '255', 'pjCountry', '1', 'name', 'Tuvalu', 'script'),
(NULL, '256', 'pjCountry', '1', 'name', 'Uganda', 'script'),
(NULL, '257', 'pjCountry', '1', 'name', 'Ukraine', 'script'),
(NULL, '258', 'pjCountry', '1', 'name', 'United Arab Emirates', 'script'),
(NULL, '259', 'pjCountry', '1', 'name', 'United Kingdom', 'script'),
(NULL, '260', 'pjCountry', '1', 'name', 'USA', 'script'),
(NULL, '261', 'pjCountry', '1', 'name', 'Uruguay', 'script'),
(NULL, '262', 'pjCountry', '1', 'name', 'Uzbekistan', 'script'),
(NULL, '263', 'pjCountry', '1', 'name', 'Vanuatu', 'script'),
(NULL, '264', 'pjCountry', '1', 'name', 'Venezuela', 'script'),
(NULL, '265', 'pjCountry', '1', 'name', 'Viet Nam', 'script'),
(NULL, '266', 'pjCountry', '1', 'name', 'Virgin Islands', 'script'),
(NULL, '267', 'pjCountry', '1', 'name', 'Wake Island', 'script'),
(NULL, '268', 'pjCountry', '1', 'name', 'Wallis and Futuna', 'script'),
(NULL, '269', 'pjCountry', '1', 'name', 'West Bank', 'script'),
(NULL, '270', 'pjCountry', '1', 'name', 'Western Sahara', 'script'),
(NULL, '271', 'pjCountry', '1', 'name', 'Yemen', 'script'),
(NULL, '272', 'pjCountry', '1', 'name', 'Zambia', 'script'),
(NULL, '273', 'pjCountry', '1', 'name', 'Zimbabwe', 'script'),
