...
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "97");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "2.2.0");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "storelocator_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjBackup', 'pjLog', 'pjInstaller', 'pjOneAdmin', 'pjCountry');
?>