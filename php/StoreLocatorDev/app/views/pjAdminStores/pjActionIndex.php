...
if (isset($tpl['status']))
{
	...
	<?php
	pjUtil::printNotice(__('infoStoresTitle', true, false), __('infoStoresDesc', true, false)); 
	?>
	<div class="b10">
	...
	<div id="dialogGetCoord" title="<?php __('lblGetCoord');?>" style="display:none;"></div>
	...
	<script type="text/javascript">
		...
		myLabel.latlng = "<?php __('lblLatLng'); ?>";
		...
		myLabel.get_coord = "<?php __('lblGetCoord');?>";
