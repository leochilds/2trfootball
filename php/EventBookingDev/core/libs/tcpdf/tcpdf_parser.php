...
// -----------------------------------------------------------------------------
	 ...
	 * @since 1.0.000 (2011-05-24)
	 */
	function getXrefData($offset=0, $xref=array()) {
		// find last startxref
	 ...
	 */
	function getRawObject($offset=0) {
	 ...
	 * @since 1.0.000 (2011-05-24)
	 */
	function getIndirectObject($obj_ref, $offset=0, $decoding=true) {
	 ...
	 */
	function decodeStream($sdic, $stream) {
