...
class PDF417 {
	 ...
	 * @protected
	 */
	var $start_pattern = '11111111010101000';

	/**
	 * Stop pattern.
	 * @protected
	 */
	var $stop_pattern = '111111101000101001';

	/**
	 * Array of text Compaction Sub-Modes (values 0xFB - 0xFF are used for submode changers).
	 * @protected
	 */
	var $textsubmodes = array(
	 ...
	 * @public
	 */
	function PDF417($code, $ecl=-1, $aspectratio=2, $macro=array()) {
		$barcode_array = array();
	 ...
	 * @protected
	 */
	function getErrorCorrectionLevel($ecl, $numcw) {
	 ...
	 * @protected
	 */
	function getErrorCorrection($cw, $ecl) {
	 ...
	 * @protected
	 */
	function getInputSequences($code) {
	 ...
	 * @protected
	 */
	function getCompaction($mode, $code, $addmode=true) {
