...
if (!defined("PJ_SCRIPT_VERSION")) define("PJ_SCRIPT_VERSION", "3.1.0");
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "56");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "3.1.1");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "eventbooking_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjLog', 'pjInstaller', 'pjBackup', 'pjPaypal', 'pjAuthorize');
?>