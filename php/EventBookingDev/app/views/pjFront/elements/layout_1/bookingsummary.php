...
<div class="ebcal-booking-form">
	<div class="ebcal-form-header">
		<div class="event-datetime">
			<?php
			echo stripslashes($tpl['arr']['event_title']) . ' | ';
	...
	<div class="ebcal-form-container">
		<form action="" method="post" name="ebcal_booking_summary" class="ebcal-form" style="width: auto">
			<div class="ebcal-form-inner-container">
				...
				<p>
					<label class="title">&nbsp;</label>
					<input type="button" value="<?php __('front_button_submit'); ?>" name="ebcal_booking_summary_submit" class="ebcal-button" />
					<input type="button" value="<?php __('front_button_cancel'); ?>" name="ebcal_booking_summary_cancel" class="ebcal-button" />
				</p>
			</div>
		</form>
	</div>
