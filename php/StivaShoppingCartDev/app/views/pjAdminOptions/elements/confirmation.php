...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionUpdate" method="post" class="form pj-form clear_both">
	...
	<div id="tabs">
		...
		<div id="tabs-1">
			...
			<fieldset class="fieldset white">
				<legend><?php __('opt_o_email_new_registration'); ?></legend>
				<?php
				foreach ($tpl['lp_arr'] as $v)
				{
					?>
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						<p class="block t5">
							<label class="title" style="width: 180px"><?php __('confirmation_subject'); ?></label>
							<input type="text" name="i18n[<?php echo $v['id']; ?>][register_subject]" class="pj-form-field w500 b10" value="<?php echo htmlspecialchars(stripslashes(@$tpl['arr']['i18n'][$v['id']]['register_subject'])); ?>" />
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1): ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
						</p>
						<p class="block t5">
							<label class="title" style="width: 180px"><?php __('confirmation_body'); ?></label>
							<textarea name="i18n[<?php echo $v['id']; ?>][register_tokens]" class="pj-form-field w500 h230"><?php echo stripslashes(@$tpl['arr']['i18n'][$v['id']]['register_tokens']); ?></textarea>
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1): ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
						</p>
			...
			<fieldset class="fieldset white">
				...
				foreach ($tpl['lp_arr'] as $v)
				{
					...
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						<p class="block t5">
							<label class="title" style="width: 180px"><?php __('confirmation_subject'); ?></label>
							<input type="text" name="i18n[<?php echo $v['id']; ?>][forgot_subject]" class="pj-form-field w500 b10" value="<?php echo htmlspecialchars(stripslashes(@$tpl['arr']['i18n'][$v['id']]['forgot_subject'])); ?>" />
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1): ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
						</p>
						<p class="block t5">
							<label class="title" style="width: 180px"><?php __('confirmation_body'); ?></label>
							<textarea name="i18n[<?php echo $v['id']; ?>][forgot_tokens]" class="pj-form-field w500 h230"><?php echo stripslashes(@$tpl['arr']['i18n'][$v['id']]['forgot_tokens']); ?></textarea>
							<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1): ?>
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
							<?php endif; ?>
						</p>
