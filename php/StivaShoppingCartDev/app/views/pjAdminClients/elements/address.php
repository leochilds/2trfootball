<div class="boxAddress">
	<a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminClients" class="pj-button float_right btnRemoveAddress"><?php __('client_del_address'); ?></a>
	<p>
		<label class="title"><?php __('client_name'); ?></label>
		<input type="text" name="name[{INDEX}]" class="pj-form-field w300" />
	</p>
	<p>
		<label class="title"><?php __('client_country'); ?></label>
		<select name="country_id[{INDEX}]" class="pj-form-field">
	...
	<p>
		...
		<input type="text" name="state[{INDEX}]" class="pj-form-field w200" />
	</p>
	<p>
		<label class="title"><?php __('client_city'); ?></label>
		<input type="text" name="city[{INDEX}]" class="pj-form-field w200" />
	</p>
	<p>
		<label class="title"><?php __('client_zip'); ?></label>
		<input type="text" name="zip[{INDEX}]" class="pj-form-field w80" />
	</p>
	<p>
		<label class="title"><?php __('client_address_1'); ?></label>
		<input type="text" name="address_1[{INDEX}]" class="pj-form-field w350" />
	</p>
	<p>
		<label class="title"><?php __('client_address_2'); ?></label>
		<input type="text" name="address_2[{INDEX}]" class="pj-form-field w350" />
	</p>
	<p>
